...
# Capture ball
CPTRBL_TRANSLATE_SPEED = .6
CPTRBL_ROTATE_SPEED = 0

# Rotate in place
ROTINPL_TRANSLATE_SPEED = 0
ROTINPL_ROTATE_SPEED = .4

# Approach target
APPTGT_TRANSLATE_SPEED = .5
APPTGT_ROTATE_SPEED = .25

# Avoid wall
AVDWLL_TRANSLATE_SPEED = -.6
AVDWLL_ROTATE_SPEED = 0
